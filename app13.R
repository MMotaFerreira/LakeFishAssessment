...
# Data####
# Load species list
species_list <- structure(list(Sps = c("Asp", "Bighead goby", "Bitterling", "Bleak", "Bream", "Brown trout", "Carp", "Catfish", "Chub", 
                                       "Dace", "Orfe", "Perch", "Pike", "Pikeperch", "Pumpkinseed", "Rainbow trout", "Roach", "Round goby", 
                                       "Rudd", "Ruffe", "Spined loach", "Stone moroko", "Tench", "Tubenose goby", "White bream", "Whitefish"), 
                               Status = c("Native", "Exotic", "Native", "Native", "Native", "Native", "Native", "Native", "Native", "Native", 
                                          "Exotic", "Native", "Native", "Native", "Exotic", "Stocked", "Native", "Exotic", "Native", "Native",
                                          "Native", "Exotic", "Native", "Exotic", "Native", "Stocked"),
                               Habitat = c("Epilimnetic", "Littoral", "Littoral", "Littoral", "Littoral", "Littoral", "Littoral", "Littoral",
                                           "Littoral", "Littoral", "Littoral", "Littoral", "Littoral", "Epilimnetic", "Littoral", "Littoral", 
                                           "Littoral", "Littoral", "Littoral", "Littoral", "Littoral", "Littoral", "Littoral", "Littoral",
                                           "Littoral", "Hypoplimnic"), 
                               Spawning = c("Lithophilic", "Lithophilic", "Psammophil", "Phyto-lithophilic", "Phyto-lithophilic", "Lithophilic", 
                                            "Phytophilic", "Phytophilic", "Lithophilic", "Lithophilic", "Phyto-lithophilic", "Phyto-lithophilic", 
                                            "Phytophilic", "Phyto-lithophilic", "Lithophilic", "Lithophilic", "Phyto-lithophilic", "Lithophilic",
                                            "Phytophilic", "Phyto-lithophilic", "Phytophilic", "Phytophilic", "Phytophilic", "Lithophilic", 
                                            "Phytophilic", "Lithophilic")), 
...
generate_breakdown_summary <- function(df) {
    ...
    cur_hab_guilds <- df |> filter(Current > 0) |> distinct(HabitatGuild) |> pull()
    ...
    cur_spawn_guilds <- df |> filter(Current > 0) |> distinct(SpawningGuild) |> pull()
    ...
    observeEvent(input$add_entry, {
        ...
        if (nrow(species_info) > 0) {
            new_row <- data.frame(
                ...
                HabitatGuild = species_info$Habitat,
                SpawningGuild = species_info$Spawning,
